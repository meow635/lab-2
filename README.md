# Lab 2: Parallel Matrix Multiplication using OpenMP
...
Алгоритм перемножения матриц имеет сложность:
...
* T1 — время выполнения на 1 потоке
* Tp — время выполнения на p потоках
